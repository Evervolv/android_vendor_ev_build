...
TARGET_KERNEL_CLANG_VERSION ?= $(LLVM_AOSP_PREBUILTS_VERSION)
...
# Rust
TARGET_KERNEL_RUST_PATH ?= $(BUILD_TOP)/prebuilts/rust/$(HOST_PREBUILT_TAG)/$(RUST_AOSP_PREBUILTS_VERSION)
...
TOOLS_PATH_OVERRIDE := \
    ...
    LD_LIBRARY_PATH=$(KERNEL_LD_LIBRARY)
