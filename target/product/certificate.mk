...
ifneq ($(filter nightly testing release,$(PRODUCT_BUILD)),)
    DEV_CERTIFICATE := releasekey
endif
DEV_CERTIFICATE ?= testkey

PRODUCT_DEFAULT_DEV_CERTIFICATE := $(SRC_EVERVOLV_DIR)/build/target/product/security/$(DEV_CERTIFICATE)
PRODUCT_EXTRA_RECOVERY_KEYS :=
PRODUCT_SOONG_NAMESPACES += $(SRC_EVERVOLV_DIR)/build/target/product/security
