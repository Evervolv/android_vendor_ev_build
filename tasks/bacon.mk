...
INTERNAL_BACON_PACKAGE_TARGET := $(INTERNAL_OTA_RETROFIT_DYNAMIC_PARTITIONS_PACKAGE_TARGET)
else
INTERNAL_BACON_PACKAGE_TARGET := $(INTERNAL_OTA_PACKAGE_TARGET)
endif

$(INTERNAL_BACON_PACKAGE): $(INTERNAL_BACON_PACKAGE_TARGET)
	$(hide) ln -f $(INTERNAL_BACON_PACKAGE_TARGET) $@
